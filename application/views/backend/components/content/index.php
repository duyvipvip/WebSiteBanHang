								...
								<table class="table table-hover table-bordered">
									...
									<?php foreach ($list as $val):?>
										<tr>
											...
											<td style="width:50px">
												<img src="public/images/posts/<?php echo $val['img'] ?>" alt="<?php echo $val['title'] ?>" class="img-responsive">
											</td>
											<td><a href="<?php echo base_url() ?>admin/content/update/<?php echo $val['id'] ?>"><?php echo $val['title'] ?></a></td>
											<td class="text-center">
												<a href="<?php echo base_url() ?>admin/content/status/<?php echo $val['id'] ?>">
													<?php if($val['status']==1):?>
											...
											<td class="text-center">
												<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/content/update/<?php echo $val['id']?>" role = "button">
													<span class="glyphicon glyphicon-edit"></span>Sửa
												</a>
											</td>
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/content/trash/<?php echo $val['id'] ?>" role = "button">
