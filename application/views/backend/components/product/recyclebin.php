									...
									<tbody>
										...
										<tr>
											...
											<td class="text-center">
												<a class="btn btn-success btn-xs" href="admin/product/restore/<?php echo $val['id'] ?>" role = "button">
											...
											<?php  
												...
												if($user['role']==1){
													$cpnDel.='
														<td class="text-center">
															<a class="btn btn-danger btn-xs" href="admin/product/delete/'.$val['id'].'" role = "button">
