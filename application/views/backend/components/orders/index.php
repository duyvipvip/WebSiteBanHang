										...
										<tr>
											...
											<td class="text-center">
												<a href="<?php echo base_url() ?>admin/orders/status/<?php echo $val['id'] ?>">
													<?php if($val['status']==1):?>
														<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/orders/status/<?php echo $val['id'] ?>" role = "button">
															<span class="glyphicon glyphicon-ok"></span> Đã duyệt
														</a>
													<?php else: ?>
														<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/orders/status/<?php echo $val['id'] ?>" role = "button">
															<span class="glyphicon glyphicon-remove"></span> Đang chờ
														</a>
													<?php endif; ?>
												</a>
											</td>
