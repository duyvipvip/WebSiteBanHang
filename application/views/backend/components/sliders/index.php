<div class="content-wrapper">
	<section class="content-header">
		...
		<div class="breadcrumb">
			<a class="btn btn-primary btn-sm" href="<?php echo base_url()?>admin/sliders/insert" role="button">
								...
								<table class="table table-hover table-bordered">
									...
									<?php foreach ($list as $val):?>
										<tr>
											...
											<td style="width:50px">
												<img src="public/images/banners/<?php echo $val['img'] ?>" alt="<?php echo $val['name'] ?>" class="img-responsive">
											</td>
											<td><a href="<?php echo base_url() ?>admin/sliders/update/<?php echo $val['id'] ?>"><?php echo $val['name'] ?></a>
											</td>
											<td> <?php echo $val['link'] ?></td>
											<td class="text-center">
												<a href="<?php echo base_url() ?>admin/sliders/status/<?php echo $val['id'] ?>">
													<?php if($val['status']==1):?>
											...
											<td class="text-center">
												<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/sliders/update/<?php echo $val['id']?>" role = "button">
													<span class="glyphicon glyphicon-edit"></span>Sửa
												</a>
											</td>
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/sliders/trash/<?php echo $val['id'] ?>" role = "button">
