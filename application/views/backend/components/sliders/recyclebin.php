								...
								<table class="table table-hover table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<a href="<?php echo base_url() ?>admin/sliders/update/<?php echo $val['id'] ?>"><?php echo $val['name'] ?></a>	
											</td>
											<td><?php echo $val['link'] ?></td>
											<td class="text-center">
												<a class="btn btn-success btn-xs" href="admin/sliders/restore/<?php echo $val['id'] ?>" role = "button">
											...
											<?php  
												...
												if($user['role']==1){
													$cpnDel.='
														<td class="text-center">
															<a class="btn btn-danger btn-xs" href="admin/sliders/delete/'.$val['id'].'" role = "button">
