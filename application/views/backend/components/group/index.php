<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="glyphicon glyphicon-cd"></i> Danh sách nhóm</h1>
								...
								<table class="table table-hover table-bordered">
									...
									<?php foreach ($list as $val):?>
										<tr>
											...
											<td>
												<a href="<?php echo base_url() ?>admin/groupadmin/update/<?php echo $val['id'] ?>"><?php echo $val['name'] ?></a>	
											</td>
											<?php  
												$detail=$this->Muser->user_detail_id($val['created_by']);
											?>
