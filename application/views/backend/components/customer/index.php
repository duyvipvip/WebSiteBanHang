								...
								<table class="table table-hover table-bordered">
									...
									<?php foreach ($list as $val):?>
										<tr>
											...
											<td>
												<a href="<?php echo base_url() ?>admin/customer/update/<?php echo $val['id'] ?>"><?php echo $val['fullname'] ?>
												</a>	
											</td>
											...
											<td class="text-center">
												<a href="<?php echo base_url() ?>admin/customer/status/<?php echo $val['id'] ?>">
													<?php if($val['status']==1):?>
											...
											<td class="text-center">
												<a class="btn btn-success btn-xs" href="<?php echo base_url() ?>admin/customer/update/<?php echo $val['id'] ?>" role = "button">
													<span class="glyphicon glyphicon-edit"></span>Sửa
												</a>
											</td>
											<td class="text-center">
												<a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>admin/customer/trash/<?php echo $val['id'] ?>" role = "button">
